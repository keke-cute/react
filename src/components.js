...
import Part2cHomework from './Components/Part2cHomework'
import Part2cHomework2 from './Components/Part2cHomework2'
...
function App () {
	...
	<header>
	    ...
	    <div className="mydiv">
  		<h1 className="myh1">Part2cHomework</h1>
		<Part2cHomework />
	    </div>
	    <div className="mydiv">
  		<h1 className="myh1">Part2cHomework2</h1>
		<Part2cHomework2 />
	    </div>
	    <Footer />
	</header>
